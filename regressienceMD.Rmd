...
#Introduction
This is "one-stop shop" regression function runs various regression algorithms on a given data set and returns information regarding each model fit and compares their cross validated results. The following regression algorithms are utilized in the main function.
